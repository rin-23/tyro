...
void updateStepTRUEVertex(const Eigen::MatrixXd& F, Eigen::MatrixXd& D, const Eigen::VectorXi& S_vec, std::vector<int>& sequenceIdx, double w_s, double& oldEnergy, double& newEnergy);
