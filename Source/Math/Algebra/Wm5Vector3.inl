...
//----------------------------------------------------------------------------
template <typename Real>
Vector3<Real>::Vector3 (Vector3&& vec)
{
...
//----------------------------------------------------------------------------
template <typename Real>
Vector3<Real>::Vector3 (Tuple<3,Real>&& tuple)
{
    mTuple[0] = tuple[0];
    mTuple[1] = tuple[1];
    mTuple[2] = tuple[2];
...
//----------------------------------------------------------------------------
template <typename Real>
Vector3<Real>::Vector3(const Real v[3])
{
    mTuple[0] = v[0];
    mTuple[1] = v[1];
    mTuple[2] = v[2];
...
//----------------------------------------------------------------------------
template <typename Real>
Vector3<Real>& Vector3<Real>::operator= (Vector3&& vec)
{
    mTuple[0] = vec.mTuple[0];
    mTuple[1] = vec.mTuple[1];
    mTuple[2] = vec.mTuple[2];
...
//----------------------------------------------------------------------------
template <typename Real>
Vector3<Real>& Vector3<Real>::operator= (Tuple<3,Real>&& tuple)
{
    mTuple[0] = tuple[0];
    mTuple[1] = tuple[1];
    mTuple[2] = tuple[2];
...
//----------------------------------------------------------------------------
template <typename Real>
inline Vector3<Real> Vector3<Real>::operator+ (Vector3&& vec) const
{
    return Vector3
    (
     mTuple[0] + vec.mTuple[0],
...
//----------------------------------------------------------------------------
template <typename Real>
inline Vector3<Real>& Vector3<Real>::operator+= (Vector3&& vec)
{
    mTuple[0] += vec.mTuple[0];
    mTuple[1] += vec.mTuple[1];
    mTuple[2] += vec.mTuple[2];
...
//----------------------------------------------------------------------------
template <typename Real>
Vector3<Real> Vector3<Real>::GetNormalized (const Real epsilon) const
{
    Vector3<Real> vec(mTuple);
    vec.Normalize(epsilon);
    return vec;
}
//----------------------------------------------------------------------------
template <typename Real>
...
//----------------------------------------------------------------------------
template <typename Real>
Vector3<Real> Vector3<Real>::Cross (Vector3&& vec) const
{
    return Vector3
    (
     mTuple[1]*vec.mTuple[2] - mTuple[2]*vec.mTuple[1],
...
//----------------------------------------------------------------------------
template <typename Real>
Vector3<Real> Vector3<Real>::UnitCross (Vector3&& vec) const
{
    Vector3 cross
    (
     mTuple[1]*vec.mTuple[2] - mTuple[2]*vec.mTuple[1],
...
//----------------------------------------------------------------------------
template <typename Real>
Vector3<Real> Vector3<Real>::GetMin(const Vector3& v1) const
{
    Vector3<Real> vmin(this->X(), this->Y(), this->Z());
    for (int i = 0; i < 3; ++i)
    {
        if (v1[i] < vmin[i])
        {
...
//----------------------------------------------------------------------------
template <typename Real>
Vector3<Real> Vector3<Real>::GetMax(const  Vector3& v1) const
{
    Vector3<Real> vmax(this->X(), this->Y(), this->Z());
    for (int i = 0; i < 3; ++i)
    {
        if (v1[i] > vmax[i])
        {
...
//----------------------------------------------------------------------------
template <typename Real>
Real Vector3<Real>::GetAngle(const Vector3& v1) const
{
    return acos(v1.Dot(*this)/(v1.Length()* this->Length()));
}

//----------------------------------------------------------------------------
template <typename Real>
void Vector3<Real>::MakeFloor(const Vector3& cmp)
{
    if( cmp.X() < mTuple[0] ) mTuple[0] = cmp.X();
    if( cmp.Y() < mTuple[1] ) mTuple[1] = cmp.Y();
    if( cmp.Z() < mTuple[2] ) mTuple[2] = cmp.Z();
}
//----------------------------------------------------------------------------
template <typename Real>
void Vector3<Real>::MakeCeil(const Vector3& cmp)
{
    if( cmp.X() > mTuple[0] ) mTuple[0] = cmp.X();
    if( cmp.Y() > mTuple[1] ) mTuple[1] = cmp.Y();
    if( cmp.Z() > mTuple[2] ) mTuple[2] = cmp.Z();
