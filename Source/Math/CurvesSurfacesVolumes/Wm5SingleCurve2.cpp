...
SingleCurve2<Real>::SingleCurve2 (Real tmin, Real tmax)
    :
...
//----------------------------------------------------------------------------
template <typename Real>
Real SingleCurve2<Real>::GetSpeedWithData (Real t, void* data)
{
    return ((Curve2<Real>*)data)->GetSpeed(t);
}
//----------------------------------------------------------------------------
template <typename Real>
Real SingleCurve2<Real>::GetLength (Real t0, Real t1) const
{
