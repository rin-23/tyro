...
public:
    ...
    Vector3& operator= (Tuple<3,Real>&& tuple);
    ...
    Vector3 GetNormalized (const Real epsilon = Math<Real>::ZERO_TOLERANCE) const;
    ...
    Vector3 UnitCross (Vector3&& vec) const;
    ...
    //Get mininum vector component wise
    Vector3 GetMin(const Vector3& v0) const;

    //Get maxium vector component wise
    Vector3 GetMax(const Vector3& v0) const;
    
    //Get angle between vectors
    Real GetAngle(const Vector3& v0) const;
